...
\section{Datenmodell}
Als Datenmodell wird RDF verwendet. Die Eingaben aus der UI werden über eine SPARQL-Schnittstelle im Quitstore gespeichert und ausgelesen. Jeder Datei wird dabei eine ID zur Identifizierung zugeordnet. Der Quitstore stellt die Daten auf Anfrage als JSON-Dateien zur Verfügung.
